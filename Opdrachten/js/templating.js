...
var template = {
    ...
    generateHtml: function (data) {
        ...
        for (var i = 0; i < data.tracks.length; i++) {
                obj.innerHTML += '<div id="trackinfo-' + data.tracks[i].id + '" class="trackinfo"><span class="title"></span><br><br><label>Link: </label><a class="permalink_url" href=""></a><br><br><label>Favorites: </label><span class="favoritings_count"></span></div><br><br>';
